...
This file should reside in the truffleProject/contracts/ directory.  These are the functions contained in CarContract.sol and the expected parameters (inputs) and return values (outputs) for each.
